...
class Trainer(object):
    ...
    def train(self):
        ...
        if self.args.max_steps > 0:
            ...
            self.args.num_train_epochs = self.args.max_steps // (len(train_dataloader[0]) // self.args.gradient_accumulation_steps) + 1
            #self.args.num_train_epochs = self.args.max_steps
        else:
            t_total = len(train_dataloader[0]) // self.args.gradient_accumulation_steps * self.args.num_train_epochs
        ...
        logger.info("  Num examples = %d", len(self.train_dataset[0]))
